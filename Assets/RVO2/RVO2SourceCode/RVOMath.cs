...
namespace RVO
{
    ...
    public struct RVOMath
    {
         ...
         * matrix.</param>
         */
        // fzy remark：计算vector1和vector2的行列式：
        // 用于计算直线外一点到直线的垂直距离
        // 也常用于判断vector2在vector1的哪一侧(见RVOMath.leftof函数)
        // 返回值大于0,表示vector2在vector1的逆时针一侧（左）
        // 返回值小于0,表示vector2在vector1的顺时针一侧（右）
        // 返回值等于0,表示vector1和vector2平行
        ...
        #region fzy add： Vector2和Vector3的互相转换
